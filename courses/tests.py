...
class CourseModelTest(TestCase):
    ...
    def test_step_ceation(self):
        step = Step.objects.create(
            title="Testing Step Creation",
            descriptions = "Just testing the step creation",
            course = self.course
        )
...
class CourseViewsTests(TestCase):
    def setUp(self):
        ...
        self.step = Step.objects.create(
            ...
            descriptions="Learn to write test dics in your docstring",
            course=self.course
        )
    ...
    def test_step_detail_view(self):
        resp = self.client.get(reverse('courses:step', kwargs={'course_pk': self.course.pk,
